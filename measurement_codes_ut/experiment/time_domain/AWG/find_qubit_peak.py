...
class FindQubitPeak(object):
    experiment_name = "FindQubitPeak"
    input_parameters = [
    ...
    def take_data(self, tdm, notes):
        ...
        qubit_port.if_freq = note.qubit_frequency_cw / 1e9
    ...
    def analyze(self, dataset, note, savefig=True, savepath="./fig"):
        ...
        freq = dataset.data["detuning"]["values"] + note.qubit_frequency_cw / 1e9
        ...
        plot.label("Frequency (GHz)", "Response")
        ...
        experiment_note.qubit_dressed_frequency = self.qubit_dressed_frequency*1e9
