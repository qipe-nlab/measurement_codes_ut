...
class HS900xBChannel(InstrumentChannel):
    """
    ...
    def _set_f(self, f:float) -> None:
        ...
        """
        f_round = round(f, 2)
        write_str = ':{}:FREQ:'.format(self.channel) + str(f_round/1e9) + 'GHz'
        read_str = self.ask(write_str)
...
class HS900xB(VisaInstrument):
    ...
    def __init__(self, name: str, address: str, **kwargs) -> None:
        ...
        knownmodels = ['hs9001b', 'hs9002b', 'hs9003b', 'hs9004b',
                       ...
                       'HS9001B', 'HS9002B', 'HS9003B', 'HS9004B',
                       'HS9005B', 'HS9006B', 'HS9007B', 'HS9008B']
        ...
        for ch_name in channels:
            channel = HS900xBChannel(self, ch_name, ch_name)
